...
export default ({
	...
	>
		...
		{!(!authorImage && !authorName && !metadata1 && !metadata2 && !metadata3 && !tag1 && !tag2 && !tag3 && !title) && (
			<div
				style={{
					height: '100%',
					width: '50%',
			...
			>
				...
				>
					{tag1 && <div style={{ backgroundColor: '#e0e8ff', padding: '5px 10px 5px 10px', borderRadius: '15px' }}>{tag1}</div>}
					{tag2 && <div style={{ backgroundColor: '#e0e8ff', padding: '5px 10px 5px 10px', borderRadius: '15px' }}>{tag2}</div>}
					{tag3 && <div style={{ backgroundColor: '#e0e8ff', padding: '5px 10px 5px 10px', borderRadius: '15px' }}>{tag3}</div>}
				</div>
			</div>
		)}
	</div>
